...
const itemTypes = ["CONSULTATION", "MEDICINE", "LAB_TEST", "PROCEDURE", "SERVICE"];
  ...
  const fetchClients = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setClients(data);
        if (data.length === 0) {
          toast.error("No patients found. Please add patients first.");
        }
      } else {
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <Select onValueChange={field.onChange} value={field.value} disabled={isLoadingClients}>
                    <FormControl>
                      <SelectTrigger>
                        <SelectValue placeholder={isLoadingClients ? "Loading patients..." : "Select patient"} />
                      </SelectTrigger>
                    </FormControl>
                    <SelectContent>
                      {isLoadingClients ? (
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <h3 className="text-sm font-semibold">Billing Items</h3>
                <Button
                  type="button"
                  variant="outline"
                  size="sm"
